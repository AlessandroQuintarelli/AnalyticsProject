...
local_directory <- getwd()#paste(getwd(),"CourseSessions/Sessions23", sep="/")
...
datafile_name="FinancialData" #  do not add .csv at the end! make sure the data are numeric!!!! check your file!
...
ProjectData[is.na(ProjectData)==TRUE]<-0
ProjectData=data.matrix(ProjectData) 

if (datafile_name == "FinancialData")
